...
FVMC = 0  # First-Visit Monto Carlo (MC) on policy evaluation
IMC = 1  # Temporal Difference Policy Evaluation
################################################################
...
###########################################################################
# partial show
plt.imshow(np.array(result_my))
plt.colorbar(cmap=cm.hot, norm=LogNorm())
plt.show()
